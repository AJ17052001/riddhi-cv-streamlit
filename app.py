...
# ====================================================================
# If you leave these as placeholders, the app will auto-generate dummy files
# so you can at least view the interface without crashing.
...
if uploaded_file is not None:
    ...
    st.image(image, caption="Target Image Matrix", use_container_width=True)
    ...
    if yolo is None or tokenizer is None or caption_model is None:
        ...
        with st.spinner("Analyzing frames and computing tags..."):
            # Prepare matrix for image arrays
            ...
            try:
                # If using the fallback generated files, display notice
                if "your-hosting-site" in CAPTION_MODEL_URL:
                    ...
                    # ⚠️ Replace the following block with your exact deep learning processing routine
                    # e.g., features = feature_extractor.predict(img_array)
